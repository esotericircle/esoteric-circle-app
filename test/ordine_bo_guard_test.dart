...
void main() {
  ...
  test('il manifesto esiste e porta tutte e quattordici le voci', () {
    ...
    for (var i = 0; i < quante; i++) {
      final voce = 'BO.${i.toString().padLeft(2, '0')}';
  ...
  test('l\'ordine BO non e\' finito finche\' una voce resta aperta', () {
    final aperte = marcatore(manifesto.readAsStringSync(), 'VOCI_APERTE');
    expect(aperte, 0,
        reason: 'restano $aperte voci APERTE nell\'ordine BO. Questa riga '
