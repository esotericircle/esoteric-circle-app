...
/// LA GUARDIA DELL'ORDINE DW, la condivisione e l'invito.
///
...
void main() {
  final manifesto = File('docs/ordini/ORDINE_DW_MANIFESTO.md');
  ...
  test('il manifesto esiste e porta tutte e otto le voci', () {
    ...
    for (var i = 1; i <= quante; i++) {
      final voce = 'DW.${i.toString().padLeft(2, '0')}';
  ...
  test('i marcatori dicono il vero, contati sulle voci', () {
    ...
    print('ORDINE DW: voci osservate ${voci.length}, chiuse $chiuse, '
  ...
  test('l\'ordine DW non e\' finito finche\' una voce resta aperta', () {
