...
void main() {
  ...
  test('Non installare NON e\' tacere: finisce nel registro', () async {
    ...
    expect(registro.haGuasti, isTrue,
        reason: 'un pannello che tace su cio\' che non e\' installato mente '
            'per omissione, ed e\' gia\' costato due giri');
    expect(registro.ultimo!.operazione, 'attestazione');
  });
