...
void main() {
  ...
  const vietati = [
    'guarigione', 'guarire', 'guarisce', 'guaritore',
    'salute', 'malattia', 'malattie', 'malato', 'malati',
    'fertilita', 'fecondita', 'sterilita', 'longevita',
    'medicina', 'medico', 'panacea', 'pietra filosofale',
    'tesori', 'tesoro', 'nemici', 'nemico',
    'prigionieri', 'prigioniero', 'promozione', 'promozioni',
    'vittoria', 'demone', 'demoni', 'goetia', 'goetica', 'goetiche',
