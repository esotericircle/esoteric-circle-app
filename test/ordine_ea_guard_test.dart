...
/// LA GUARDIA DELL'ORDINE EA, le correzioni dopo la 2272.
///
/// **Non e' una promessa, e' una prova che non passa.** Legge il manifesto e
/// resta rossa finche' le ventuno voci non hanno uno stato terminale. Le
/// guardie del difetto vivono nelle loro prove, nominate voce per voce nel
/// manifesto.
///
/// **Una riga vuota non chiude una voce**: i censimenti delle voci 06 e 17
/// sono tabelle, e una tabella vuole la riga vuota prima. La voce la chiude
/// la voce dopo, o un titolo.
void main() {
  ...
  test('il manifesto esiste e porta tutte e ventuno le voci', () {
    ...
    for (var i = 1; i <= quante; i++) {
      final voce = 'EA.${i.toString().padLeft(2, '0')}';
  ...
  test('i marcatori dicono il vero, contati sulle voci', () {
    ...
    print('ORDINE EA: voci osservate ${voci.length}, chiuse $chiuse, '
  ...
  test('l\'ordine EA non e\' finito finche\' una voce resta aperta', () {
