...
LE TRE PARTI, CIOE COSA UN RESPONSO DEVE DIRE (ordine S, recepito il 14 agosto 2026). I quattro strati qui sopra sono la FORMA con cui un responso si presenta. Accanto a loro vale un secondo asse, che e l obbligo di CONTENUTO e non si fonde col primo in un vocabolario solo. Parte 1, la risposta: cosa la lettura vede nella situazione di chi legge, da due a quattro righe. Parte 2, cosa puoi fare: un indicazione concreta e compibile oggi o nei prossimi giorni, mai ascolta te stesso, ed e la parte che fa tornare. Parte 3, da dove viene: perche quella runa, quella carta o quel transito dice questo, ed e LI che il simbolo compare, non prima. Parte 4, la tradizione: NON sta dentro il responso, scende nel pannello delle fonti e del metodo che esiste gia.

IL SIMBOLO NON APRE MAI. Un responso che comincia col nome della runa, della carta o del pianeta chiede a chi legge di sapere cosa vuol dire quel simbolo prima di ricevere una risposta. Il nome arriva nella parte 3 e serve a dire da dove viene cio che si e appena letto.

UN DONO NON E UN RESPONSO. La riga dell Oracolo del Giorno, il messaggio del mattino e il saluto della notte sono il solo strato 1: una riga che si legge in due secondi, e l azione la porta il rito che le sta attorno. Pretendere le tre parti dentro settanta caratteri trasformerebbe un dono in un responso.

UN APERTURA STABILE PER GRUPPO O PER DOMANDA E ACCETTATA, e la ragione e che una lente variabile davanti a un testo stabile produce piu varieta di quanta ne produrrebbe riscrivere il testo. Le sedici cornici del presagio delle rune sono una per domanda e non variano per runa: la runa porta la sua frase di corpus, la cornice porta la domanda, ed e per questo che non servono cinquecentosettantasei testi. Le tre risposte del consiglio dei tarocchi sono una per gruppo e si innestano sulla lente dell argomento: sedici lenti per tre risposte fanno sedici aperture diverse.
...
IL CONFINE DEL RESPONSO, E VIVE IN UN PUNTO SOLO. Cosa si puo dire e cosa non si dice mai e scritto una volta e arriva sia ai corpora deterministici sia alle istruzioni di sistema del modello: una regola scritta due volte sono due regole, e divergono al primo ritocco. Non si danno previsioni date per certe, ne consigli medici, legali o finanziari. Sui temi delicati la regola e piu fine di un divieto di parole: il difetto non e nominare la malattia o il denaro, e RIVOLGERE alla persona una previsione su quel tema dentro la stessa frase. Una riga che parla di eredita in generale non e una violazione; una che dice a te accadra questo lo e.

IL RIPIEGO NON SI DICHIARA MAI. Quando il modello risponde, il responso e suo; quando non risponde, e il testo deterministico, e chi legge non deve poter capire quale dei due sta leggendo. Niente avvisi, niente icone, e nessuno scambio di testo a video: se una bolla mostra il ripiego e poi lo sostituisce, la persona vede lo scambio e capisce. Il guasto pero si scrive nel registro: alla persona non si dice niente, a noi si.

L ISTRUZIONE DI SISTEMA E L ARTEFATTO PIU FRAGILE DEL PROGETTO. Tiene distinte le tre voci, che e la promessa del prodotto, e una sola riga generica aggiunta in coda ha gia fatto scendere un Maestro dal 98 al 70 per cento di riconoscibilita. Si tocca solo quando si puo rimisurare: l impronta della stringa emessa e registrata come dato, e chi la cambia ha due strade e nessuna terza, rilanciare l attribuzione cieca e aggiornare il dato, oppure dichiarare che si consegna con una misura non valida. I quattro strati della chat sono la sua FORMA, le tre parti sono l obbligo di contenuto, e il LEGAME fra i due assi vive in un dato percorribile da una prova, non in un commento.

I TESTI DEI RESPONSI SONO MATERIALE DELL ARCHITETTO, E LA LORO FONTE STA NEL REPOSITORY. Chi scrive codice non inventa un testo di responso e non lo riformula. Le fonti vivono in docs, e una prova confronta il codice con la fonte carattere per carattere: verbatim senza una prova e un proposito. Le domande proposte alla persona vivono in un punto unico, perche due elenchi della stessa cosa sono due elenchi da tenere d accordo a mano.
...
LA REGOLA DEL COMPIMENTO E L ORDINE NEL CAMMINO. Un traguardo si accende quando il gesto e COMPIUTO, non quando e cominciato, e cio che si mostra e sempre il passo successivo, mai un elenco di cose fatte. Il cammino ha 55 posizioni per sentiero, numerate da 1 a 55 e sempre nello stesso ordine: cinque grandi traguardi dopo il decimo, il ventesimo, il trentesimo, il quarantesimo e il cinquantesimo mini-traguardo. L ordine non e una convenzione grafica, e il dato: chi disegna la schermata non puo rimetterlo in fila per conto suo.

IL SIGILLO E UN SEGNO IMPRESSO SU QUALCOSA. Un intreccio di tratti sospeso sul fondo si legge come uno scarabocchio: servono una forma che lo contenga, un fondo su cui stia e un bordo che lo chiuda, e il segno dentro con un margine dichiarato che non tocchi mai la cornice.
...
QUATTRO REGOLE DI PROVA, e valgono per chiunque lavori qui. Una soglia non puo derivare dalla grandezza che deve giudicare, altrimenti si allarga insieme al difetto. Una prova che enumera dichiara quante osservazioni ha fatto davvero e cade se sono zero: un enumerazione larga sembra forte anche quando gira a vuoto. La prova del rosso si esegue verificando PRIMA che l iniezione sia entrata, perche una sostituzione che non trova la riga lascia la prova verde su codice intatto, e quel verde e indistinguibile da un rosso mai eseguito. E le anteprime si guardano alla larghezza vera e alla risoluzione vera, tutte: un immagine vuota non dice va bene, dice che non si e guardato niente.
