...
| Guardie con un cardinale proprio dichiarato | 148 |
| Guardie che non scoprono nessun insieme di file | 241 |
| **Somma delle categorie** | **533** |
| **Guardie secondo la definizione** | **533** |
...
| `gli_sfondi_delle_schede_test.dart` | i 99 sfondi delle schede stanno in assets/schede, registrati, dieci per Maestro | 1 | proprio, dichiarato | 26/09/2026, EO.01 (la suite intera l'ha colta senza cardinale: dichiarato) | 1 |
...
| `nessun_doppione_in_vista_test.dart` | nella home nessuna scheda in vista ripete un'arte vista piu' su, a 360, 390 e 412 punti e a testo 1,3 | 1 | proprio, dichiarato | 26/09/2026, EO.17 (due innesti: le righe che non ricordano, la vista contata corta) | 1 |
