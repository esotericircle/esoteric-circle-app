...
| Guardie con un cardinale proprio dichiarato | 112 |
| Guardie che non scoprono nessun insieme di file | 191 |
| **Somma delle categorie** | **438** |
| **Guardie secondo la definizione** | **438** |
...
| `nessun_messaggio_si_scrive_due_volte_test.dart` | **la coda verso il server non manda due volte la stessa scrittura**: la domanda e il turno del Maestro arrivano una volta sola e tutti e due; dieci scritture insieme ognuna una volta e in ordine; una scrittura arrivata mentre la coda finiva non resta indietro | 1 | non scopre insiemi in `lib` | 18/09/2026, DV (la coda di prima: *Carta del giorno* scritta due volte e RangeError sulla coda vuota) | 1 |
