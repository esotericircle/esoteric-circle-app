...
| Guardie che non scoprono nessun insieme di file | 185 |
| **Somma delle categorie** | **423** |
| **Guardie secondo la definizione** | **423** |

**Ricontate a ordine DQ chiuso**, 16 settembre 2026, che ha portato **quattro guardie nuove**, tutte senza insiemi di file: `il_manifesto_della_privacy`, `i_cinque_guasti_della_voce_di_casa`, `la_seconda_chiamata` e `il_velo_di_cenere_continuo`. Il totale sale da 419 a **423** e le tre categorie a **131, 107 e 185**. Le prove del cammino a strati, `il_cammino_a_strati`, sono prove di valore e non stanno nel conto; sono state viste rosse lo stesso, su quattro innesti.
