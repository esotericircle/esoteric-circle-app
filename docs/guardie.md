...
| Guardie che non scoprono nessun insieme di file | 211 |
| **Somma delle categorie** | **484** |
| **Guardie secondo la definizione** | **484** |

**Ricontate a ordine EF**, 23 settembre 2026, il Soffio del Destino rifatto e guardato a video: **quattro guardie nuove**, due col cardinale proprio, una dalla porta comune e una che non scopre insiemi. Il totale sale da 480 a **484** e le tre categorie a **140, 133 e 211**. **Due sono nate rosse su difetti VERI e non innestati**, che e' il modo migliore in cui una guardia puo' nascere: il riquadro copriva la figura di 47,0 punti su due geometrie della griglia. E `il_soffione_respira` ha cambiato soggetto per la seconda volta in due giorni, perche' la misura dell'ordine EE descriveva una combinazione che a video non esiste mai.
...
| `ogni_maestro_saluta_con_la_sua_voce_test.dart` | i tre non si salutano con le stesse parole, e nessuno usa il lessico degli altri | 1, 2 | proprio, dichiarato | 21/09/2026, EB (nata rossa: dodici benvenuti identici su dodici e venti saluti col lessico altrui) | 3 |
