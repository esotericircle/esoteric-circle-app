...
| categoria | quante |
| --- | ---: |
| Guardie che passano dalla porta comune | 143 |
| Guardie con un cardinale proprio dichiarato | 143 |
| Guardie che non scoprono nessun insieme di file | 233 |
| **Somma delle categorie** | **519** |
| **Guardie secondo la definizione** | **519** |
