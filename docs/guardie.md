...
| Guardie che non scoprono nessun insieme di file | 181 |
| **Somma delle categorie** | **419** |
| **Guardie secondo la definizione** | **419** |

**Ricontate a ordine DO chiuso**, 15 settembre 2026, che ha portato **una guardia nuova**, `il_sigillo_vive`, che non scopre insiemi di file: il totale sale da 418 a **419** e le tre categorie a **131, 107 e 181**. Pretende assenze: nessuna scritta sullo sfondo fuori dal segno, pixel per pixel sui tre fondi veri; nessun contatore di carica nel Libro; nessuna intenzione nel testo della chiamata; nessun maschile a chi ha scelto il femminile nella riformulazione; e le famiglie di testi trovate dalle sette sonde col modello vero, ognuna con la frase che il modello ha scritto davvero. **Quarantanove innesti, quarantasette rossi**: i due verdi erano cieche della riformulazione, perche' la guardia dei terzi del Viaggio prendeva gli stessi casi; una e' stata tolta, l'altra rifatta su un caso che solo lei vede, e al secondo innesto sono diventate rosse. `sigillo_schermata` e' stata riscritta sul percorso nuovo del Sigillo, la via prima di scrivere e il Libro.
