...
| Guardie con un cardinale proprio dichiarato | 106 |
| Guardie che non scoprono nessun insieme di file | 180 |
| **Somma delle categorie** | **417** |
| **Guardie secondo la definizione** | **417** |
...
| `il_responso_risponde_test.dart` | le guardie del titolo, della risposta e del gesto del modello, una riga per ogni motivo dello scarto; l'oggetto della domanda con l'articolo, le maiuscole, senza prima persona e col possessivo solo se la domanda diceva mio; i testi del modello nel responso e nel Diario con la loro fonte; nessun paragrafo del gesto con due tempi su duemilacento discese | 1, 2 | proprio, dichiarato | 14/09/2026, DL (quattro rossi: la guardia della previsione certa tolta, il quando rimesso ai gesti col tempo, le previsioni senza futuro tolte, il possessivo non controllato) | 1 |
