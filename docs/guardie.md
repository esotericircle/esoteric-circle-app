...
| categoria | quante |
| --- | ---: |
| Guardie che passano dalla porta comune | 135 |
| Guardie con un cardinale proprio dichiarato | 110 |
| Guardie che non scoprono nessun insieme di file | 189 |
| **Somma delle categorie** | **434** |
| **Guardie secondo la definizione** | **434** |
...
| `il_sacchetto_dell_alba_test.dart` | **ogni ciclo porta i quarantaquattro stati una volta sola e la stessa carta non torna prima di undici estrazioni, anche fra due cicli**, su centoventi semi per sei cicli; il verso non segue la carta; vuoto o corrotto si ricompone e non blocca | 1 | non scopre insiemi in `lib` | 17/09/2026, DT (finestra tolta: la carta torna dopo una estrazione; componibilita' tolta: un ciclo ricomposto a meta') | 2 |
| `l_arcano_dell_alba_si_gira_test.dart` | **un gesto solo e nessun altro comando** sull'Arcano dell'Alba; carte coperte uguali; la faccia solo dopo meta' giro; **il verso non lo decide la carta toccata**; il limite delle stese intatto; nel cammino i gesti alba e oracolo; il dorso uguale a se stesso al mezzo giro | 1 | non scopre insiemi in `lib` | 17/09/2026, DT (caso deciso dalla carta toccata e gesto dell'oracolo tolto: due rosse) | 2 |
