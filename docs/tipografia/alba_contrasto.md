...
| --- | --- | --- | --- | ---: | ---: | --- | --- | ---: | ---: | --- |
| `alba_invito_al_gesto` | prima del gesto | lib/features/rituals/dawn_rite_screen.dart:779 | lettura | 20 | 400 | #F0D77B | #081A22 | **12.45** | 4.5 | si' |
| `alba_titolo` | prima del gesto | lib/features/rituals/dawn_rite_screen.dart:555 | titoloScheda | 20 | 600 | #F4F1E8 | #02090B | **17.77** | 3.0 | si' |
...
| `alba_titolo_risposta` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:243 | titoloSezione | 22 | 600 | #2A2213 | #DCDED2 | **11.54** | 3.0 | si' |
...
| `alba_testo_del_mantra` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:144 | lettura | 20 | 400 | #2A2213 | #CBD3C6 | **10.23** | 4.5 | si' |
| `alba_titolo_della_via_tattile` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:159 | corpo o didascalia | 16 | 400 | #084F3B | #E5E7D6 | **7.58** | 4.5 | si' |
| `alba_via_tattile_del_mantra` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:164 | corpo o didascalia | 16 | 400 | #4A4537 | #CBD3C6 | **6.19** | 4.5 | si' |
| `alba_etichetta_parola` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:382 | lettura | 20 | 400 | #554627 | #DCDED2 | **6.69** | 4.5 | si' |
| Piano | a rito compiuto | senza chiave | cerimonialeGrande | 34 | 700 | #084F3B | #D0D5CB | **6.37** | 3.0 | si' |
| `alba_perche_della_parola` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:403 | lettura | 20 | 400 | #2A2213 | #DCDED2 | **11.54** | 4.5 | si' |
| `alba_lente_della_parola` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:427 | lettura | 20 | 400 | #554627 | #DCDED2 | **6.69** | 4.5 | si' |
| `alba_dove_va_la_parola` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:442 | lettura | 20 | 400 | #554627 | #DCDED2 | **6.69** | 4.5 | si' |
| Da dove nasce | a rito compiuto | senza chiave | display a misura | 14 | 600 | #084F3B | #EDEADD | **7.89** | 4.5 | si' |
| `alba_base_etichetta_perché_questo_rito` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:659 | lettura | 20 | 400 | #554627 | #E5E1D1 | **6.96** | 4.5 | si' |
| `alba_base_valore_perché_questo_rito` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:674 | lettura | 20 | 400 | #2A2213 | #CBCDC2 | **9.76** | 4.5 | si' |
| `alba_base_etichetta_ancora_natale` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:659 | lettura | 20 | 400 | #554627 | #E5E1D1 | **6.96** | 4.5 | si' |
| `alba_base_valore_ancora_natale` | a rito compiuto | lib/features/rituals/ritual_gift_card.dart:674 | lettura | 20 | 400 | #2A2213 | #CBCDC2 | **9.76** | 4.5 | si' |
...
| `alba_titolo` | a rito compiuto | lib/features/rituals/dawn_rite_screen.dart:555 | titoloScheda | 20 | 600 | #F4F1E8 | #0A0F17 | **17.00** | 3.0 | si' |
