...
| Grandezza | Valore |
| --- | --- |
| Misure esplicite sotto `lib/` | **225** |
...
| `lib/features/maestri/caligo/sigillo/sigillo_intenzione_screen.dart` | 10 | 0 | 0 |
...
| `lib/features/account/account_screen.dart` | 2 | 0 | 0 |
...
| `lib/features/maestri/caligo/animal/bosco_del_cerchio.dart` | 2 | 0 | 0 |
...
| `lib/features/synastry/sinastria_gallery_screen.dart` | 2 | 0 | 0 |
