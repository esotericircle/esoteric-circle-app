...
| Grandezza | Valore |
| --- | --- |
| Misure esplicite sotto `lib/` | **103** |
| File che ne contengono | **38** |
...
| --- | ---: | ---: | ---: |
| `lib/features/rituals/sunset_rune_screen.dart` | 10 | 0 | 0 |
| `lib/features/maestri/caligo/animal/guide_animal_screen.dart` | 9 | 0 | 0 |
| `lib/features/maestri/caligo/sigillo/sigillo_intenzione_screen.dart` | 7 | 0 | 0 |
| `lib/features/account/dati_di_nascita_screen.dart` | 6 | 0 | 0 |
| `lib/features/rituals/dream_rite_screen.dart` | 5 | 0 | 0 |
...
| `lib/features/synastry/sinastria_vip_screen.dart` | 3 | 0 | 0 |
...
| `lib/design_system/components/consulto_del_cielo_view.dart` | 2 | 0 | 0 |
| `lib/design_system/components/vip_frame.dart` | 2 | 0 | 0 |
| `lib/features/maestri/ask/ask_maestri_screen.dart` | 2 | 0 | 0 |
| `lib/features/maestri/aura/face/face_share_card.dart` | 2 | 0 | 0 |
| `lib/features/maestri/caligo/animal/animal_journey.dart` | 2 | 0 | 0 |
| `lib/features/maestri/caligo/rune/rune_share_card.dart` | 2 | 0 | 0 |
| `lib/features/maestri/chat/widgets/chat_suggestions.dart` | 2 | 0 | 0 |
| `lib/features/passport/cosmic_passport_screen.dart` | 2 | 0 | 0 |
| `lib/features/passport/specchio_dei_dati.dart` | 2 | 0 | 0 |
| `lib/features/pricing/pricing_screen.dart` | 2 | 0 | 0 |
| `lib/features/pricing/upgrade_invite.dart` | 2 | 0 | 0 |
| `lib/features/santuario/widgets/tue_arti_view.dart` | 2 | 0 | 0 |
| `lib/features/identity/widgets/birth_companions.dart` | 1 | 0 | 0 |
| `lib/features/maestri/aura/meditation/meditation_screen.dart` | 1 | 0 | 0 |
