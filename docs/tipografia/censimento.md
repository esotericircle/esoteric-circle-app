...
| Grandezza | Valore |
| --- | --- |
| Misure esplicite sotto `lib/` | **95** |
| File che ne contengono | **37** |
...
| `lib/features/rituals/sunset_rune_screen.dart` | 8 | 0 | 0 |
...
| `lib/features/rituals/dream_rite_screen.dart` | 3 | 0 | 0 |
...
| `lib/features/synastry/sinastria_vip_screen.dart` | 2 | 0 | 0 |
