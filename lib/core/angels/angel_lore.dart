...
const Map<int, AngelLore> kAngelLore = {
  ...
  22: AngelLore(
    ...
    sign: 'Cancro',
    psalm: 'Salmo 121,5 nella numerazione ebraica, corrispondente al Salmo 120,5 della Vulgata: «Il Signore è il tuo custode, il Signore è la tua ombra e sta alla tua destra», in latino «Dominus custodit te; Dominus protectio tua super manum dexteram tuam». Verificato sulla stampa di Lenain del 1823 con l\'ordine CS.',
  ...
  24: AngelLore(
    ...
    sign: 'Cancro',
    psalm: 'Salmo 33,18 nella numerazione ebraica, corrispondente al Salmo 32,18 della Vulgata: «Ecco, l\'occhio del Signore è su chi lo teme, su chi spera nel suo amore», in latino «Ecce oculi Domini super metuentes eum, et in eis qui sperant in misericordia eius». Verificato sulla stampa di Lenain del 1823 con l\'ordine CS.',
  ...
  59: AngelLore(
    ...
    reading: 'L\'apertura che sa apprezzare senza svalutare. Ti dà misura nel giudizio insieme al gusto di trasmettere quello che sai.',
    confidence: 'alta',
  ),
  60: AngelLore(
    number: 60,
