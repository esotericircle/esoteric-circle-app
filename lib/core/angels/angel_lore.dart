...
const Map<int, AngelLore> kAngelLore = {
  ...
  22: AngelLore(
    ...
    sign: 'Cancro',
    psalm:
        'Salmo 121,5 nella numerazione ebraica, corrispondente al Salmo 120,5 della Vulgata: «Il Signore è il tuo custode, il Signore è la tua ombra e sta alla tua destra», in latino «Dominus custodit te; Dominus protectio tua super manum dexteram tuam». Verificato sulla stampa di Lenain del 1823 con l\'ordine CS.',
    tradition:
  ...
  24: AngelLore(
    ...
    sign: 'Cancro',
    psalm:
        'Salmo 33,18 nella numerazione ebraica, corrispondente al Salmo 32,18 della Vulgata: «Ecco, l\'occhio del Signore è su chi lo teme, su chi spera nel suo amore», in latino «Ecce oculi Domini super metuentes eum, et in eis qui sperant in misericordia eius». Verificato sulla stampa di Lenain del 1823 con l\'ordine CS.',
    tradition:
  ...
  57: AngelLore(
    ...
    tradition:
        'Le imprese che chiedono strategia e responsabilita\', le cause da difendere, le situazioni in cui qualcuno resta bloccato.',
    reading:
  ...
  65: AngelLore(
    ...
    tradition:
        'Tutto cio\' che scorre: le acque, i viaggi per mare, i legami che si sciolgono senza rancore. La tradizione lo invoca anche contro i malefici, riferimento da riportare come dato storico e non come garanzia di protezione.',
    reading:
  ...
  71: AngelLore(
    ...
    tradition:
        'Le controversie, la protezione di persone e beni, le scelte in cui bisogna dire no. Anche l\'ascolto, inteso come capacita\' di sentire cio\' che non viene detto.',
    reading:
