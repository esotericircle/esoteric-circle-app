...
const List<Rune> kElderFuthark = [
  Rune(name: 'Fehu', glyph: 'ᚠ', keyword: 'Abbondanza', meaning: 'Il bestiame, l\'abbondanza che scorre: raccogli senza trattenere.', stem: 'rune_bone_01_fehu_v1', upright: 'L\'abbondanza che scorre. Beni ed energia che circolano: non da trattenere, ma da far muovere perché fruttino.', shadow: 'L\'abbondanza che sfugge. Beni che si disperdono, o un attaccamento a ciò che hai: apri la mano, ciò che trattieni troppo si consuma.'),
  Rune(name: 'Uruz', glyph: 'ᚢ', keyword: 'Forza', meaning: 'L\'uro selvaggio, vigore grezzo: la forza che apre il varco.', stem: 'rune_bone_02_uruz_v1', upright: 'La forza che sale. Vigore grezzo, coraggio primordiale: la potenza che ti rimette in piedi.', shadow: 'La forza mal spesa. Vigore speso di slancio, oppure un\'energia che cala: ritrova il ritmo prima di caricare.'),
  ...
  Rune(name: 'Sowilo', glyph: 'ᛊ', keyword: 'Luce', meaning: 'Il sole, l\'energia che guida: la volontà ritrova la sua luce.', stem: 'rune_bone_16_sowilo_v1', upright: 'Il sole che guida. La luce che orienta e la volontà che tiene la rotta: energia piena, la via si illumina.', shadow: 'Il sole dietro le nubi. Una volontà stanca, una luce velata: l\'energia c\'è, aspetta che la nube passi.'),
  Rune(name: 'Tiwaz', glyph: 'ᛏ', keyword: 'Giustizia', meaning: 'Tyr, il coraggio giusto: agisci con onore, anche a un prezzo.', stem: 'rune_bone_17_tiwaz_v1', upright: 'La lancia della giustizia. Coraggio, onore, sacrificio per il giusto: l\'esito giusto che si merita, non quello che si strappa.', shadow: 'La lancia che devia. Un coraggio incerto, un\'energia che cala: ritrova il tuo giusto e la mira torna ferma.'),
