...
class ArchetypeCorpus {
  ...
  static const Map<Archetype, ArchetypeRitratto> _per = {
    ...
    Archetype.realista: ArchetypeRitratto(
      ...
      amore: 'In amore cerchi appartenenza vera, un legame concreto fatto di presenza e di fiducia reciproca. Non ami le grandi scene, preferisci i gesti quotidiani che dicono ci sono. Stai bene con chi ti accetta senza pretese e resta accanto nel tempo. Il rischio è accontentarti o lasciarti trascinare dal cinismo quando resti deluso. Ami davvero quando resti aperto e vicino, senza alzare muri per difenderti.',
      lavoro: 'Sul lavoro sei affidabile e tieni unito il gruppo, quello su cui tutti sanno di poter contare. Porti buon senso, empatia e concretezza dove servono i piedi per terra. Non cerchi il palco, cerchi che le cose funzionino davvero. Il tuo limite è il vittimismo o il cinismo quando ti senti poco riconosciuto. Il tuo valore emerge quando resti autentico e fai da collante umano della squadra.',
      quotidianita: 'Nella quotidianità stai tra gli altri da pari, senza maschere né piedistalli, con empatia e semplicità. Tieni i piedi per terra quando tutti perdono la testa e riporti al concreto. Ti bastano cose vere e rapporti sinceri per stare bene. Il tuo rischio è perderti nella massa o lasciarti indurire dalla delusione. Trovi equilibrio quando resti umano e vicino senza rinunciare a te stesso.',
    ),
    ...
    Archetype.giullare: ArchetypeRitratto(
      ...
      amore: 'In amore porti leggerezza e gioia: sai far ridere chi ami anche nei giorni storti. Vivi il rapporto con spontaneità, senza pesi né drammi costruiti. La tua ironia scioglie le tensioni e tiene fresco il legame. Il rischio è restare in superficie e scappare quando le cose si fanno serie. Ami davvero quando dietro il gioco lasci entrare la profondità e resti anche nel difficile.',
      lavoro: 'Sul lavoro allenti le tensioni e riporti tutti al presente, perché sei il respiro del gruppo. Con una battuta sblocchi un clima teso e fai vedere le cose da un\'altra angolazione. Dietro lo scherzo c\'è un\'intelligenza che coglie ciò che gli altri non dicono. Il tuo limite è la fuga dalle responsabilità e la mancanza di un\'ancora. Il tuo valore cresce quando all\'ironia unisci costanza e serietà quando serve.',
      quotidianita: 'Nella quotidianità vivi l\'attimo e prendi la giornata con il sorriso, senza caricarti di pesi inutili. Sai godere delle piccole cose e trasformare un momento grigio in una risata. La solennità e la rigidità ti stanno strette. Il tuo rischio è evitare tutto ciò che è scomodo e non prendere niente sul serio. Trovi equilibrio quando alla leggerezza aggiungi il coraggio di guardare anche il difficile.',
    ),
