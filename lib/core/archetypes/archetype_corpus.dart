...
class ArchetypeRitratto {
  const ArchetypeRitratto({
    ...
    required String essenza,
    required String luce,
    required String ombra,
    required String amore,
    required String lavoro,
    required String quotidianita,
  }) : _essenza = essenza, _luce = luce, _ombra = ombra, _amore = amore, _lavoro = lavoro, _quotidianita = quotidianita;

  final Archetype archetipo;

  /// Una riga sola, quella che sta sulla card e sotto il nome.
  final String _essenza;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get essenza => LaMarcaDelGenere.risolvi(_essenza);

  final String _luce;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get luce => LaMarcaDelGenere.risolvi(_luce);
  final String _ombra;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get ombra => LaMarcaDelGenere.risolvi(_ombra);
  final String _amore;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get amore => LaMarcaDelGenere.risolvi(_amore);
  final String _lavoro;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get lavoro => LaMarcaDelGenere.risolvi(_lavoro);

  /// Come l'archetipo vive la giornata, coerente con essenza, luce e ombra.
  final String _quotidianita;

  /// Risolto con la forma della persona, ordine DL voce 02.
  String get quotidianita => LaMarcaDelGenere.risolvi(_quotidianita);
}
...
class ArchetypeCorpus {
  ...
  static const Map<Archetype, ArchetypeRitratto> _per = {
    ...
    Archetype.saggio: ArchetypeRitratto(
      ...
      amore:
          'In amore vai in profondità e cerchi una mente con cui capirti oltre le parole. Ti innamori di chi ti fa pensare e con cui puoi condividere il senso delle cose. La tua lealtà è solida, ma tieni le emozioni a distanza per proteggerti. Il rischio è analizzare il sentimento invece di viverlo, [restando spettatore|restando spettatrice|guardandolo da fuori]. Impari ad amare quando scaldi la testa col cuore e ti lasci toccare davvero.',
      lavoro:
          'Sul lavoro [sei il consigliere e lo stratega, quello|sei la consigliera e la stratega, quella|porti consiglio e strategia: sei chi] vede lontano e mette ordine nella confusione. Le persone vengono da te per capire, perché dici ciò che è vero e non ciò che conviene. La tua lucidità evita errori che agli altri sfuggono. Il tuo limite è restare nel pensiero senza passare all\'azione, in attesa della certezza perfetta. Il tuo valore cresce quando la conoscenza diventa decisione.',
      quotidianita:
    ...
    Archetype.eroe: ArchetypeRitratto(
      ...
      quotidianita:
          'Nella quotidianità affronti la giornata di petto e trasformi ogni ostacolo in una sfida da vincere. Non rimandi, agisci, [ti senti vivo|ti senti viva|senti la vita] quando c\'è qualcosa per cui lottare. La calma e l\'attesa ti pesano più della fatica. Il tuo rischio è vivere sempre in tensione e cercare battaglie che non servono. Trovi equilibrio quando impari che non tutto va combattuto e che a volte basta esserci.',
    ),
    ...
    Archetype.mago: ArchetypeRitratto(
      ...
      lavoro:
          'Sul lavoro [sei il visionario|sei la visionaria|porti la visione] che apre strade e vede possibilità dove gli altri vedono muri. Trasformi le situazioni e trovi soluzioni che sembravano impossibili. La tua intuizione cambia il corso di ciò che pareva già scritto. Il tuo limite è la tentazione di manipolare e di prendere scorciatoie per il potere. Diventi grande quando la visione resta onesta e serve un bene più ampio del tuo.',
      quotidianita:
    ...
    Archetype.realista: ArchetypeRitratto(
      ...
      luce:
          'Hai conosciuto la vita per quello che è. [Ne sei uscito concreto e vero|Ne sei uscita concreta e vera|Ne hai tratto concretezza e verità] senza smettere di [essere umano|essere umana|avere umanità]. Non ti servono maschere né piedistalli, stai tra gli altri da pari con empatia e buon senso. [Sei quello|Sei quella|Sei la persona] su cui si può contare, che tiene i piedi per terra quando tutti perdono la testa. La tua forza è [restare autentico e vicino|restare autentica e vicina|l\'autenticità e la vicinanza].',
      ombra: 'Vittimismo e cinismo, si perde nella massa.',
      amore:
          'In amore cerchi appartenenza vera, un legame concreto fatto di presenza e di fiducia reciproca. Non ami le grandi scene, preferisci i gesti quotidiani che dicono ci sono. Stai bene con chi ti accetta senza pretese e resta accanto nel tempo. Il rischio è accontentarti o lasciarti trascinare dal cinismo quando [resti deluso|resti delusa|arriva la delusione]. Ami davvero quando [resti aperto e vicino|resti aperta e vicina|non ti chiudi e resti accanto], senza alzare muri per difenderti.',
      lavoro:
          'Sul lavoro sei affidabile e tieni unito il gruppo: [quello|quella|la persona] su cui tutti sanno di poter contare. Porti buon senso, empatia e concretezza dove servono i piedi per terra. Non cerchi il palco, cerchi che le cose funzionino davvero. Il tuo limite è il vittimismo o il cinismo quando [ti senti poco riconosciuto|ti senti poco riconosciuta|il riconoscimento non arriva]. Il tuo valore emerge quando [resti autentico|resti autentica|resti fedele a chi sei] e fai da collante umano della squadra.',
      quotidianita:
          'Nella quotidianità stai tra gli altri da pari, senza maschere né piedistalli, con empatia e semplicità. Tieni i piedi per terra quando tutti perdono la testa e riporti al concreto. Ti bastano cose vere e rapporti sinceri per stare bene. Il tuo rischio è perderti nella massa o lasciarti indurire dalla delusione. Trovi equilibrio quando [resti umano e vicino|resti umana e vicina|resti accanto con umanità] senza rinunciare a [te stesso|te stessa|te].',
    ),
    Archetype.amante: ArchetypeRitratto(
      archetipo: Archetype.amante,
      essenza: 'Nel legame, la vita.',
      luce:
          'Vivi le cose con intensità: il legame con gli altri è dove [ti senti davvero vivo|ti senti davvero viva|senti davvero la vita]. Sai creare bellezza e intimità, ti doni con passione e fai sentire l\'altro visto e importante. Per te un rapporto non è un contorno della vita, è la vita stessa. La tua forza è la capacità di amare e di unire.',
      ombra: 'Ossessivo e geloso, si smarrisce nell\'altro.',
      amore:
          'In amore sei nel tuo territorio: vivi il legame con una passione totale che riempie la vita. Sai creare intimità e bellezza. Fai sentire l\'altro visto, desiderato e importante. Ti doni per intero e cerchi una connessione profonda, non un contorno. Il rischio è annullarti nell\'altro o soffocarlo con gelosia e possesso. Ami davvero quando [resti te stesso|resti te stessa|resti chi sei] mentre ti unisci, senza perderti.',
      lavoro:
    ...
    Archetype.custode: ArchetypeRitratto(
      ...
      lavoro:
          'Sul lavoro sei il collante della squadra: [quello|quella|la persona] che tiene insieme le persone e le sostiene. Ti accorgi di chi è in difficoltà e ci sei, con generosità e senza clamore. Crei un ambiente sicuro dove gli altri possono dare il meglio. Il tuo limite è caricarti troppo e diventare [il martire che si sacrifica|la martire che si sacrifica|chi si sacrifica per tutti]. Il tuo dono fiorisce quando la cura resta scelta libera e non un debito da riscuotere.',
      quotidianita:
          'Nella quotidianità pensi agli altri prima che a [te stesso|te stessa|te] e ti prendi cura di chi ti circonda. La casa, gli affetti e la vicinanza sono il tuo centro, il posto dove dai il meglio. Ti riempie il gesto di esserci per qualcuno che ne ha bisogno. Il tuo rischio è annullarti e ricattare con il senso di colpa quando [non sei riconosciuto|non sei riconosciuta|il riconoscimento manca]. Stai bene quando ti prendi cura anche di te con la stessa tenerezza.',
    ),
