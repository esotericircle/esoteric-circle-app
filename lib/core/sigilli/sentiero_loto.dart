...
final List<Traguardo> sentieroDelLoto = [
  Traguardo(
    ...
    frase:
        'Hai dato al Cerchio la Mappa del Viso: da adesso ogni responso parte da qui.',
    posizione: 1,
    percheConta: FamigliaDelTraguardo.identita.percheContaLaFamiglia,
    cosaApre: 'La Mappa del Viso, che da qui entra nel tuo profilo',
    eGrande: false,
    eos: 10,
    fascia: 'Primi giorni',
    dormiente: false,
  ...
  Traguardo(
    ...
    frase: 'Hai compiuto la Mappa del Viso in 12 giorni diversi.',
    posizione: 14,
    percheConta: FamigliaDelTraguardo.profondita.percheContaLaFamiglia,
  ...
  Traguardo(
    ...
    condizione: const FinestraDelCielo(EventiDelCielo.lunaNelTuoSegno,
        conGesto: 'viso'),
    frase: 'La Luna passa nel tuo segno: tu eri qui con la Mappa del Viso.',
    posizione: 21,
    percheConta: FamigliaDelTraguardo.cielo.percheContaLaFamiglia,
  ...
  Traguardo(
    ...
    frase: 'Hai compiuto la Mappa del Viso in 55 giorni diversi.',
    posizione: 28,
    percheConta: FamigliaDelTraguardo.profondita.percheContaLaFamiglia,
  ...
  Traguardo(
    ...
    frase: 'Hai compiuto la Mappa del Viso in 280 giorni diversi.',
    posizione: 50,
    percheConta: FamigliaDelTraguardo.profondita.percheContaLaFamiglia,
