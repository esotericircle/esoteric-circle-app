...
///
/// E' un modello riusabile, pensato per stare sia nella carta natale sia nel
/// profilo, e domani nel Cosmic Passport. Sono identita', non i moduli completi:
/// la Lunologia quotidiana resta a Medora e la numerologia completa a Caligo, in
/// fase successiva.
@immutable
class BirthIdentity {
  const BirthIdentity({
